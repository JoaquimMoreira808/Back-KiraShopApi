...
{
    /// <inheritdoc />
    public partial class MiggrationInicial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdutoCategoria", x => new { x.CategoriasId, x.ProdutosId });
                    table.ForeignKey(
                        name: "FK_ProdutoCategoria_Categorias_CategoriasId",
                        column: x => x.CategoriasId,
                        principalTable: "Categorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdutoCategoria_Produtos_ProdutosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutoCategoria_ProdutosId",
